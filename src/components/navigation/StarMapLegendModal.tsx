  ...
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center p-4 bg-black/80">
      <div className="terminal-modal max-w-md w-full max-h-[90vh] overflow-y-auto">
        ...
        {/* Map Legend Section - Hex Visualization */}
        <div className="mb-6 pb-6 border-b border-[#1a2420]">
          <h3 className="text-sm font-bold text-primary uppercase mb-4 tracking-wider">
            Map Legend
          </h3>
            ...
            <div className="relative" style={{ width: '220px', height: '220px' }}>
              ...
              <svg viewBox="0 0 220 220" className="w-full h-full">
                ...
                <g transform="translate(110, 110)">
                  ...
                  />
                  {/* World name */}
                  <text x="0" y="-2" textAnchor="middle" className="fill-white text-[9px] font-bold">
                    World
                  </text>
                  <text x="0" y="8" textAnchor="middle" className="fill-white text-[9px] font-bold">
                    Name
                  </text>
                  {/* 1003 */}
                  <text x="0" y="22" textAnchor="middle" className="fill-[#ff3344] text-[8px] font-mono">
                    1003
                  </text>
                  {/* G5 */}
                  <text x="12" y="22" textAnchor="middle" className="fill-white text-[7px] font-mono">
                    G5
                  </text>
                  {/* Dots for water and other indicators */}
                  <circle cx="-10" cy="-36" r="2.5" fill="#00ccff" />
                  <circle cx="0" cy="-36" r="2.5" fill="white" />
                  <circle cx="10" cy="-36" r="2.5" fill="white" />

                  {/* Surrounding hexagons with labels */}
                  {/* Top hexagon - Starport Type */}
                  <g transform="translate(0, -60)">
                    <polygon
                      ...
                      opacity="0.5"
                    />
                    <text x="0" y="-35" textAnchor="middle" className="fill-[#00aa00] text-[7px]">
                      Starport
                    </text>
                    <text x="0" y="-27" textAnchor="middle" className="fill-[#00aa00] text-[7px]">
                      Type
                    </text>
                  </g>

                  {/* Top-right hexagon - Gas Giant */}
                  ...
                  {/* Bottom-right hexagon - Allegiance */}
                  <g transform="translate(48, 30)">
                    <polygon
                      points="0,-28 24,-14 24,14 0,28 -24,14 -24,-14"
                      fill="none"
                      ...
                      opacity="0.5"
                    />
                    <text x="0" y="38" textAnchor="middle" className="fill-[#00aa00] text-[7px]">
                      Allegiance
                    </text>
                  </g>

                  {/* Top-left hexagon - Bases */}
                  <g transform="translate(-48, -30)">
                    <polygon
                      points="0,-28 24,-14 24,14 0,28 -24,14 -24,-14"
                      fill="none"
                  ...
                  {/* Bottom-left hexagon - X-Boat Route */}
                  <g transform="translate(-48, 30)">
                    <polygon
                      points="0,-28 24,-14 24,14 0,28 -24,14 -24,-14"
                      fill="none"
                    ...
                    <text x="0" y="45" textAnchor="middle" className="fill-[#00aa00] text-[7px]">
                      Route
                    </text>
                  </g>

                  {/* Bottom hexagon - Lacicyt */}
                  <g transform="translate(0, 60)">
                    <polygon
                      points="0,-28 24,-14 24,14 0,28 -24,14 -24,-14"
                      fill="none"
