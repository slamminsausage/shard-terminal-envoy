...
export const TURRET_WEAPONS: TurretWeaponDef[] = [
  ...
  // ── High Guard Exotic Turret Weapons ─────────────────────────────
  {
    id: 'plasma_pulse_cannon_turret',
    name: 'Plasma-pulse Cannon',
    tl: 13,
    range: 'Medium',
    power: 10,
    damage: '2D',
...
export const BARBETTE_WEAPONS: BarbetteWeaponDef[] = [
  ...
  // ── High Guard Exotic Barbettes ──────────────────────────────────
  {
    id: 'plasma_pulse_barbette',
    name: 'Plasma-pulse Cannon Barbette',
    tl: 13,
    range: 'Medium',
    power: 20,
    damage: '3D',
  ...
  {
    id: 'tachyon_cannon_barbette',
    name: 'Tachyon Cannon Barbette',
    tl: 14,
    range: 'Long',
    power: 6,
    damage: '2D',
...
export const SMALL_BAY_WEAPONS: BayWeaponDef[] = [
  ...
  // ── High Guard Exotic Small Bays ─────────────────────────────────
  {
    id: 'neutron_laser_bay',
    name: 'Neutron Laser Bay',
    tl: 16,
    range: 'Long',
    power: 40,
    damage: '7D',
  ...
  {
    id: 'tachyon_cannon_bay',
    name: 'Tachyon Cannon Bay',
    tl: 14,
    range: 'Long',
    power: 10,
    damage: '4D',
...
export const SPINAL_WEAPONS: SpinalWeaponDef[] = [
  ...
  // ── High Guard Exotic Spinal Mounts ──────────────────────────────
  {
    id: 'antimatter_spinal',
    name: 'Antimatter Spinal Mount',
    tl: 21,
    range: 'Long',
    baseSizeTons: 12000,
    powerPerMultiple: 2500,
    damagePerMultiple: '+12D',
    costPerMultiple: 5000,
    maxSizeTons: 200000,
    traits: ['Radiation'],
    damageMultiple: 1000,
  },
  {
    id: 'neutron_laser_spinal',
    name: 'Neutron Laser Spinal',
    tl: 16,
    range: 'Very Long',
    baseSizeTons: 20000,
    powerPerMultiple: 6000,
    damagePerMultiple: '+8D',
    costPerMultiple: 25000,
    maxSizeTons: Infinity,
    traits: [],
    damageMultiple: 1000,
  },
  {
    id: 'super_laser_spinal',
    name: 'Super Laser Spinal',
    tl: 16,
    range: 'Very Long',
    baseSizeTons: 20000,
    powerPerMultiple: 6000,
    damagePerMultiple: '+14D',
    costPerMultiple: 25000,
    maxSizeTons: Infinity,
    traits: [],
    damageMultiple: 1000,
  ...
  {
    id: 'tachyon_cannon_spinal',
    name: 'Tachyon Cannon Spinal',
    tl: 14,
    range: 'Long',
    baseSizeTons: 3500,
    powerPerMultiple: 500,
    damagePerMultiple: '+7D',
    costPerMultiple: 750,
    maxSizeTons: 28000,
    traits: ['AP 15'],
    damageMultiple: 1000,
...
export const SCREENS: ScreenDef[] = [
  ...
  // ── High Guard Exotic Screens ────────────────────────────────────
  {
    id: 'deflector_screens',
    name: 'Deflector Screens',
    tl: 10,
    power: 10,
    tons: 5,
    cost: 5,
    effect: 'Reduces damage from any weapon by 1D multiplied by the Effect of the Angle Screens (gunner) action.',
  },
  {
    id: 'energy_shields',
    name: 'Energy Shields',
    ...
    tons: 20,
    cost: 25,
    effect: 'Creates a damage buffer of 10 points. All installed shields combine their buffers. All incoming damage is deducted from the buffer first; when it reaches 0, damage applies to the ship normally. Regenerates 1 point per round; a successful Difficult (10+) Engineer (power) check doubles recovery for that round.',
  },
  {
    id: 'improved_energy_shields',
    name: 'Improved Energy Shields',
    tl: 18,
    power: 75,
    tons: 15,
    cost: 35,
    effect: 'Buffer of 20 damage points per shield. Regenerates 2 points per round.',
  },
  {
    id: 'advanced_energy_shields',
    name: 'Advanced Energy Shields',
    tl: 20,
    power: 100,
    tons: 10,
    cost: 60,
    effect: 'Buffer of 50 damage points per shield. Regenerates 5 points per round.',
  },
  {
    id: 'white_globe_generator',
    name: 'White Globe Generator',
    tl: 20,
    power: 100,
    tons: 50,
    cost: 1000,
    effect: 'Projects a glowing white energy barrier that absorbs all incoming fire while allowing the ship to function normally (manoeuvre, sensors, weapons). Absorbed damage is channelled into capacitors (jump drive capacitors = 20% of drive tons, 50 pts/ton each; extra at MCr3/ton). Ship explodes instantly if capacitors overflow. Discharge rate when offline: 1% of hull tonnage × 10% of power plant tonnage per round.',
    notes: 'TL20+. Extremely rare. Requires sufficient capacitor capacity to avoid catastrophic overload.',
  },
];
